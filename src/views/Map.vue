<template>
  <div class="sol">
    ...
    <div class ="results">
      <div v-if="results !== null"><p>Longitude: {{results.longitude}} </p>
    ...
    <div class="map">
      ...
      <div>
        ...
        <p><router-link to="/views/sunrise">See It on the map!</router-link> </p>
       </div>
  ...
  mounted: function() {
    axios
        ...
        .then(response => {
          ...
          this.iss_position = this.results.iss_position
        })
        .catch(error => {
